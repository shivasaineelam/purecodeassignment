...
import {
  ...
  findMenuItem,
  getMenuItemFromURL,
} from "./../../helper/verticalmenuhelper/verticalmenuhelper";
...
const VerticalMenu = ({ menuItems }) => {
  ...
  return (
    <ul className="admin-menu hs-accordion-group flex w-full flex-col gap-1.5 p-4 h-80 overflow-y-scroll scrollbar-hide example">
      {(menuItems ?? []).map((item) => {
        return (
